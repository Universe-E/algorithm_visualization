public class MineSweeperData {
    ...
    public static final String BASEURL = System.getProperty("user.dir")+"/resources/";
    public static final String blockImageURL = BASEURL + "block.png";
    public static final String flagImageURL = BASEURL + "flag.png";
    public static final String mineImageURL = BASEURL + "mine.png";
